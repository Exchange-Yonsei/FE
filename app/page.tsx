...
export default function Home() {
  return (
    <main>
      <section className="bg-gradient-to-b from-yonsei-light to-white">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            <p className="inline-flex rounded-full border border-blue-soft bg-white px-4 py-2 text-sm font-bold text-ink">LocalMate Yonsei</p>
          ...
          <div className="rounded-[2rem] border border-blue-soft bg-white p-5 shadow-soft">
            <div className="rounded-[1.5rem] bg-yonsei-light p-5">
              <div className="flex items-center gap-3">
                <span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-yonsei-secondary">
                  <Coffee className="h-6 w-6" aria-hidden />
                </span>
                <div>
                  <p className="text-sm font-bold text-yonsei-secondary">Tonight near Sinchon</p>
      ...
      <section className="mx-auto grid max-w-6xl gap-4 px-4 pb-16 sm:grid-cols-3">
        {cards.map((card) => {
          ...
          return (
            <article key={card.title} className="rounded-3xl border border-blue-soft bg-white p-5 shadow-soft">
              <span className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-yonsei-light text-yonsei-secondary">
