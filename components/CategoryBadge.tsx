...
export function CategoryBadge({ category }: { category: string }) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full border border-blue-soft bg-yonsei-light px-3 py-1 text-xs font-semibold text-yonsei-primary">
